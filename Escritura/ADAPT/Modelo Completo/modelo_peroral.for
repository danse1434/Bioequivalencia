...
C----c-----------------------------------------------------------------C
      ...
      NSParam = 5   ! Enter # of System Parameters.
      ...
      Descr   = 'Model Peroral con Output'
...
C----c-----------------------------------------------------------------C
        ...
        PSym(1) = 'KE' ! Constante de velocidad de eliminación
        PSym(2) = 'KA1' ! Constante de velocidad de absorción 1
        PSym(3) = 'V'  ! Volumen de Distribución
        PSym(4) = 'F'  ! Biodisponibilidad
        PSym(5) = 'KA2'  ! Constante de velocidad de absorción 2
...
C----c-----------------------------------------------------------------C
      If (R(1) .eq. 1) then
        Y(1) = B(1)*P(4)*P(2)/(P(3)*(P(2)-P(1))) * (DEXP(-P(1)*T) -
     *           DEXP(-P(2)*T))          
      Else
        Y(1) = B(1)*1*P(5)/(P(3)*(P(5)-P(1))) * (DEXP(-P(1)*T) -
     *           DEXP(-P(5)*T))          
      Endif
